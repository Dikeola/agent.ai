...
const Navbar = ({theme, setTheme}) => {
  ...
  return (
    ...
    backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70'>
        ...
        max-sm:pt-20 flex sm:items-center gap-5 transition-all z-40`}>
        ...
        <img 
            ...
            className={`w-8 sm:hidden cursor-pointer transition-opacity duration-300 fixed right-4 top-1/2 -translate-y-1/2 z-30 ${sidebarOpen ? 'opacity-0' : 'opacity-100'}`}
        />
        <div/>
    </div>
  )
